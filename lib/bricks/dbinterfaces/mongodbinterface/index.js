...
class MongoDBInterface extends BaseDBInterface {
  constructor(cementHelper, configuration) {
    ...
    this.helpers.set('deleteonebyobjidtype', new DeleteOneByObjIdTypeHelper(this.cementHelper, this.logger));
    ...
    this.helpers.set('updateonebyobjidtype', new UpdateOneByObjIdTypeHelper(this.cementHelper, this.logger));
