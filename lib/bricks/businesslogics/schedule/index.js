...
class Schedule extends Base {
  constructor(cementHelper, configuration) {
    ...
    this.helpers.set('deletebyobjidtype', new DeleteByObjIdTypeHelper(this.cementHelper, this.logger));
    ...
    this.helpers.set('updatebyobjidtype', new UpdateByObjIdTypeHelper(this.cementHelper, this.logger));
    this.helpers.set('synchronize', new SynchronizeHelper(this.cementHelper, this.logger, this.scheduler));
  }
